...
if __name__ == "__main__":
    ...
    np.savetxt("./attributes_data.csv", attributes_list, delimiter=',')
    print("Process complete, save as attributes_data.csv. One attributes list represent 165 XYZ accel datapoint.")
